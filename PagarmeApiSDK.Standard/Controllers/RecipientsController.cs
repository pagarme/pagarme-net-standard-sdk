...
namespace PagarmeApiSDK.Standard.Controllers
{
    ...
    internal class RecipientsController : BaseController, IRecipientsController
    {
        ...
        /// <param name="cancellationToken"> cancellationToken. </param>
        /// <returns>Returns the Models.CreateKYCLinkResponse response from the API call.</returns>
        public async Task<Models.CreateKYCLinkResponse> CreateKYCLinkAsync(
                string recipientId,
                CancellationToken cancellationToken = default)
            => await CreateApiCall<Models.CreateKYCLinkResponse>()
              .RequestBuilder(_requestBuilder => _requestBuilder
        ...
        /// <param name="idempotencyKey">Optional parameter: Example: .</param>
        /// <returns>Returns the Models.GetRecipientResponse response from the API call.</returns>
        public Models.GetRecipientResponse UpdateRecipientCode(
                string recipientId,
                Models.UpdateRecipientCodeRequest request,
                string idempotencyKey = null)
            => CoreHelper.RunTask(UpdateRecipientCodeAsync(recipientId, request, idempotencyKey));
        ...
        /// <param name="cancellationToken"> cancellationToken. </param>
        /// <returns>Returns the Models.GetRecipientResponse response from the API call.</returns>
        public async Task<Models.GetRecipientResponse> UpdateRecipientCodeAsync(
                string recipientId,
                Models.UpdateRecipientCodeRequest request,
                string idempotencyKey = null,
                CancellationToken cancellationToken = default)
            => await CreateApiCall<Models.GetRecipientResponse>()
              .RequestBuilder(_requestBuilder => _requestBuilder
                  .Setup(new HttpMethod("PATCH"), "/recipients/{recipient_id}/code")
                  .WithAuth("httpBasic")
                  .Parameters(_parameters => _parameters
                      .Body(_bodyParameter => _bodyParameter.Setup(request))
                      .Template(_template => _template.Setup("recipient_id", recipientId))
